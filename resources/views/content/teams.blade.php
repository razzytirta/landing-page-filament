                ...
                <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp"
                    ...
                    <div class="relative overflow-hidden px-6">
                        <img src="{{ Storage::url($team->image) }}"
                            class="max-w-full h-auto mx-auto rounded-full bg-gray-50 grayscale" alt="{{ $team->name }}">
                    </div>
                    <div class="pt-6 text-center">
                        <p class="text-lg leading-normal font-bold mb-1">{{ $team->name }}</p>
                        <p class="text-gray-500 leading-relaxed font-light">{{ $team->job_title }}</p>
                        <!-- social icon -->
                        <div class="mt-2 mb-5 space-x-2">
                            @if ($team->twitter)
                                <a class="hover:text-blue-700" aria-label="Twitter link" href="{{ $team->twitter }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="1rem" height="1rem"
                                        viewBox="0 0 512 512">
                            ...
                            @endif
                            @if ($team->instagram)
                                <a class="hover:text-blue-700" aria-label="Instagram link" href="{{ $team->instagram }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="1rem" height="1rem"
                                        viewBox="0 0 512 512">
                                        <path fill="currentColor"
